...
/**
 * @title DeployDepegShield
 * @notice Deploys DepegShield deterministically to any chain with a Uniswap v4 `PoolManager`.
 *
 ...
 */
contract DeployDepegShield is Script {
    ...
    function run() external {
        ...
        bytes memory creationCode = type(DepegShieldHook).creationCode;
        ...
        console2.log("DepegShield ", predicted);
        ...
        require(
            keccak256(bytes(IHookMetadata(address(hook)).hookName())) == keccak256(bytes("DepegShield")),
